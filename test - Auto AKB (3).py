...
room_ids_to_monitor = [
  "61637", "61562", "61553", "61603", "289892", "61534", "61585", "409793", "92055", "61570",
    "148862", "92042", "92043", "409817", "409813", "409794", "409809", "409801", "409805", "61532",
]
    ...
    while True:
        ...
        for room_id in room_ids_to_monitor:
            ...
            if streaming_url:
                ...
                output_filename = f"content/drive/MyDrive/HDD-DIMAS/SHOWROOM/downloadsAKB48/Live Showroom-{room_name}_{timestamp}.mp4"
        ...
        if not found:
            ...
            time.sleep(60)  # Jeda 1 menit sebelum mencoba lagi
...
if __name__ == '__main__':
    while True:
        ...
        time.sleep(60)  # Jeda 1 menit sebelum mencoba lagi setelah semua selesai
